...
class appDevDebugProjectContainer extends Container
{
    ...
    public function __construct(array $buildParameters = array(), $containerDir = __DIR__)
    {
        ...
        $this->normalizedIds = array(
            'administrationbundle\\controller\\defaultcontroller' => 'AdministrationBundle\\Controller\\DefaultController',
            'administrationbundle\\controller\\locationscontroller' => 'AdministrationBundle\\Controller\\LocationsController',
            'administrationbundle\\controller\\slidescontroller' => 'AdministrationBundle\\Controller\\SlidesController',
            'administrationbundle\\controller\\tagscontroller' => 'AdministrationBundle\\Controller\\TagsController',
            'administrationbundle\\form\\tagtype' => 'AdministrationBundle\\Form\\TagType',
            'displaybundle\\controller\\defaultcontroller' => 'DisplayBundle\\Controller\\DefaultController',
        ...
        $this->fileMap = array(
            'AdministrationBundle\\Controller\\DefaultController' => 'getDefaultControllerService.php',
            'AdministrationBundle\\Controller\\LocationsController' => 'getLocationsControllerService.php',
            'AdministrationBundle\\Controller\\SlidesController' => 'getSlidesControllerService.php',
            'AdministrationBundle\\Controller\\TagsController' => 'getTagsControllerService.php',
            'AdministrationBundle\\Form\\TagType' => 'getTagTypeService.php',
            'DisplayBundle\\Controller\\DefaultController' => 'getDefaultController2Service.php',
            ...
            'service_locator.9ebjpmg' => 'getServiceLocator_9ebjpmgService.php',
            'service_locator.nxuixba' => 'getServiceLocator_NxuixbaService.php',
        ...
        $this->privates = array(
            ...
            'AdministrationBundle\\Form\\TagType' => true,
            ...
            'service_locator.9ebjpmg' => true,
            'service_locator.nxuixba' => true,
    ...
    protected function getTwig_LoaderService()
    {
        ...
        $instance->addPath(($this->targetDirs[3].'/vendor/doctrine/doctrine-bundle/Resources/views'), '!Doctrine');
        $instance->addPath(($this->targetDirs[3].'/src/AdministrationBundle/Resources/views'), 'Administration');
        $instance->addPath(($this->targetDirs[3].'/src/AdministrationBundle/Resources/views'), '!Administration');
        $instance->addPath(($this->targetDirs[3].'/src/DisplayBundle/Resources/views'), 'Display');
        $instance->addPath(($this->targetDirs[3].'/src/DisplayBundle/Resources/views'), '!Display');
    ...
    private function getDynamicParameter($name)
    {
        switch ($name) {
            ...
            case 'kernel.bundles_metadata': $value = array(
                ...
                'AdministrationBundle' => array(
                    'parent' => NULL,
                    'path' => ($this->targetDirs[3].'/src/AdministrationBundle'),
                    'namespace' => 'AdministrationBundle',
                ),
                'DisplayBundle' => array(
                    'parent' => NULL,
                    'path' => ($this->targetDirs[3].'/src/DisplayBundle'),
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'kernel.bundles' => array(
                ...
                'AdministrationBundle' => 'AdministrationBundle\\AdministrationBundle',
                'DisplayBundle' => 'DisplayBundle\\DisplayBundle',
