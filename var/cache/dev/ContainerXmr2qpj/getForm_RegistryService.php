...
return $this->services['form.registry'] = new \Symfony\Component\Form\FormRegistry(array(0 => new \Symfony\Component\Form\Extension\DependencyInjection\DependencyInjectionExtension(new \Symfony\Component\DependencyInjection\ServiceLocator(array('AdministrationBundle\\Form\\TagType' => function () {
    return ${($_ = isset($this->services['AdministrationBundle\Form\TagType']) ? $this->services['AdministrationBundle\Form\TagType'] : $this->services['AdministrationBundle\Form\TagType'] = new \AdministrationBundle\Form\TagType()) && false ?: '_'};
